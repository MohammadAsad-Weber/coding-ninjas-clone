...
// Emojis
import HandShake from "../../assets/Images/Emoji/handshake.webp";
...
function SpecificationCard(props) {
  return (
    <div className="py-1.5 px-3 flex items-center gap-2.5 bg-[#2d2d2d] rounded-3xl">
...
function AboutIIT() {
  return (
    <div id="webinar" className="w-full py-10 px-5 flex justify-center gap-14 bg-[radial-gradient(58.21%_100%_at_50%_0%,_#394966_0%,_#1b1d22_68.75%,_#141414_100%)] lg:pt-16">

        {/* Left Section */}
        <div className="max-w-md w-full flex flex-col items-center gap-7 lg:items-start lg:mt-14">

          {/* Title */}
          <h1 className="text-3xl text-white font-semibold lg:text-[2.125rem] leading-10">
            PG Certification in Data Analytics by E&ICT IIT Guwahati
          </h1>

          {/* Paragraph */}
          <p className="hidden text-gray-300/90 lg:block">
            Get years ahead in just six months through practice-based learning and real-world projects.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-1">
            <SpecificationCard img={HandShake} title="Earn Alumni Status by E&ICT Academy, IIT-G" />
            <SpecificationCard img={Placement} title="Orientation & Graduation ceremony at E&ICT, IIT-G" />
          </div>

          {/* Analytics */}
          <div className="w-full min-w-[315px] my-2.5 p-4 flex items-center justify-evenly bg-[#2b303c] rounded-2xl lg:my-7 lg:px-2">
            <AnalyticCard heading="6" subHeading="Months" />
            <div className="w-[1px] h-full bg-[#394871]"></div> {/* Divider */}
            <AnalyticCard heading="1:1" subHeading="Doubt support" />
            <div className="w-[1px] h-full bg-[#394871]"></div> {/* Divider */}
            <AnalyticCard heading="20" subHeading="Expert sessions" />
            <div className="w-[1px] h-full bg-[#394871]"></div> {/* Divider */}
            <AnalyticCard heading="11" subHeading="Case studies" />
          </div>
