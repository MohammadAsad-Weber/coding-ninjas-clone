...
function Footer() {
  ...
  return (
    <div className="flex justify-center bg-[radial-gradient(at_top_center,_#000_0,_#293658_100%)]">

      {/* Inner div */}
      <div className="max-w-screen-xl w-full py-14 px-10 flex flex-col gap-10 min-[550px]:flex-row min-[550px]:flex-wrap min-[810px]:justify-evenly">
